	...
	(function(t, e, o) {
		var i = {
				...
				for (
					...
					(a += n.itemWidth),
						...
						n.options.scrollPerPage === !0 &&
							...
							i !== s &&
								((n.pagesInArray[s] = n.positionsInArray[e]),
								(s = i)));
			},
			...
			gestures: function() {
				...
				function n(e) {
					"on" === e
						? (t(o).on(l.ev_types.move, a),
						  t(o).on(l.ev_types.end, r))
						: "off" === e &&
